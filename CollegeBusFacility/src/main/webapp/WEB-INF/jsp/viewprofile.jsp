...
<h1 style="color:white; font-family: sans-serif;text-align: center;font-weight: bold;">VIEW PROFILE DETAILS</h1>
...
<form action="viewuserdetails"></form>
 <table  name="viewuserdetails"  class="table table-striped caption-top" style="background-color:#f8f9fa;border-radius:5px;">
                    <caption style="color:#9708e9;font-weight:bold;text-align: center;">VIEW PROFILE</caption>
                    <thead>
                    <tr>
                        <th scope="col">Id</th>
...
<button type="button" onclick="alert('Done!')" style=" color:white;background-color: blue;">Agree</button>
<button type="button" onclick="alert('Sorry!')"style=" color:white;background-color: blue;">I Don't Agree!</button></div>
</div>
</body>
</html>